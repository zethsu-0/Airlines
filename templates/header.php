...
<nav>
    <div class="nav-wrapper">
              ...
              <ul class="hide-on-med-and-down" id="asdasd">
                <li><a class="" style="position: relative; top: 15px; right: -1250px;" id="lolap" href="ticket.php><i class="material-icons left" id="mat">airplane_ticket</i>Get your tickets here</a></li>
              </ul>  
